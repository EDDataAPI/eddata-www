...
function Dialog() {
  ...
  useEffect(() => {
    ...
    dialogContext?.contents
      ? setContents(dialogContext.contents)
      : setContents(undefined)
    dialogContext?.buttons
      ? setButtons(dialogContext.buttons)
      : setButtons(
  ...
  return (
    <>
      {backdrop ? (
        <div
          className='dialog__background fx__fade-in'
      ...
      <div className='dialog__container'>
        <div className='dialog fx__fade-in'>
          ...
          <div className='dialog__content'>
            <div className='dialog__inner-content scrollable'>{contents}</div>
          </div>
          <div className='dialog__buttons'>{buttons}</div>
        </div>
      </div>
    </>
  )

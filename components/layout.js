  ...
  return (
    <>
      ...
      >
        {sidebar !== undefined && (
          <div
            className={`layout__content layout__content--left-sidebar scrollable ${navigation !== undefined ? 'layout__content--with-navigation' : ''}`}
          >
            {sidebar}
          </div>
        )}
        <div
          className={`layout__content scrollable ${sidebar !== undefined ? 'layout__content--right' : ''} ${navigation !== undefined ? 'layout__content--with-navigation' : ''} ${navigationOverlaid === true ? 'layout__content--with-navigation-overlayed' : ''} ${inspector !== undefined ? 'layout__content--with-inspector' : ''}`}
        >
          {children}
        </div>
        {inspector !== undefined && (
          <div className='layout__inspector scrollable'>{inspector}</div>
        )}
        {navigation !== undefined && (
